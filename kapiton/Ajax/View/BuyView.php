...
class BuyView {
	...
	public function getContentHtml() {
		...
		$html .= "
			<fieldset>
			    <legend><strong>Registrera ny köp-order:</strong></legend>
			    <label for='bcOrder'>Antal bitcoins</label><br />
			    <input type='text' value='0.1' class='buyOrderInput' id='bcOrder'><br />
			    <label for='sekOrder'>Önskat pris <small>(per 1st bc, ej för vald mängd)</small></label><br />
			    <input type='text' value='4900' class='buyOrderInput' id='sekOrder'><br />
			    <input id='buyOrderSubmit' type='button' value='Lägg order' />
			</fieldset>
		";
	...
	public function orderWithCell() {
		$this->setMsg('Order har satts och vi meddelar dig via sms när köp genomförts!');
	}
